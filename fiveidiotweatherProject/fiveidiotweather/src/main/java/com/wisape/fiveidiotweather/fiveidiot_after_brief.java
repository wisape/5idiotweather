...
public class fiveidiot_after_brief extends Fragment {
    ...
    private void setViewData(View view, List<Map<String, Object>> data_map) {
        ...
        ((ImageView) view.findViewById(R.id.image_1)).setImageResource(R.drawable.cloud);
        ...
        ((ImageView) view.findViewById(R.id.image_2)).setImageResource(R.drawable.cloud);
        ...
        ((ImageView) view.findViewById(R.id.image_3)).setImageResource(R.drawable.cloud);
        ...
        ((ImageView) view.findViewById(R.id.image_4)).setImageResource(R.drawable.cloud);
    }
}
